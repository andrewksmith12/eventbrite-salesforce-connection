...
r = requests.get(BASE_URL + 'orders/914223927/attendees'.format(orgID=MISSION_CAPITAL_ORG_ID), headers=auth_header, params={"expand":"category","expand":"promotional_code"})
data = r.json()
